// Macro to semi-automatically annotate mitotic errors or defects
// Will be integrated with lineage data after trackmate parsing

// Open 1-Ch movie
// Select appropriate "_lineages.csv" (after trackmate lineage parsing)
// Annotations will be saved automatically in the same folder

// Important: Close tables in between movies!
